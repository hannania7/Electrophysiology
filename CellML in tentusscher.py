...
def plot_model(voi, states, algebraic, rates):
    ...
    axes[0][0].plot(voi, states[0])
    axes[0][1].plot(voi, states[3])
    axes[0][2].plot(voi, algebraic[52])
    axes[0][3].plot(voi, algebraic[56])
    axes[1][0].plot(voi, algebraic[50])
    axes[1][1].plot(voi, algebraic[51])
    axes[1][2].plot(voi, algebraic[54])
    axes[1][3].plot(voi, algebraic[49])
    plt.show()
